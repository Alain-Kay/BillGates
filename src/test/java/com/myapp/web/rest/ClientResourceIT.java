...
class ClientResourceIT {
    ...
    private static final String DEFAULT_POST_NOM = "AAAAAAAAAA";
    private static final String UPDATED_POST_NOM = "BBBBBBBBBB";
    ...
    void createClient() throws Exception {
        ...
        assertThat(testClient.getPostNom()).isEqualTo(DEFAULT_POST_NOM);
        assertThat(testClient.getNumeroClient()).isEqualTo(DEFAULT_NUMERO_CLIENT);
    ...
    void getAllClients() throws Exception {
        ...
        restClientMockMvc
            ...
            .andExpect(jsonPath("$.[*].postNom").value(hasItem(DEFAULT_POST_NOM)))
    ...
    void getClient() throws Exception {
        ...
        restClientMockMvc
            ...
            .andExpect(jsonPath("$.postNom").value(DEFAULT_POST_NOM))
    ...
    void putExistingClient() throws Exception {
        ...
        assertThat(testClient.getPostNom()).isEqualTo(UPDATED_POST_NOM);
        assertThat(testClient.getNumeroClient()).isEqualTo(UPDATED_NUMERO_CLIENT);
    ...
    void partialUpdateClientWithPatch() throws Exception {
        ...
        partialUpdatedClient.nomClient(UPDATED_NOM_CLIENT).postNom(UPDATED_POST_NOM).numeroClient(UPDATED_NUMERO_CLIENT);
