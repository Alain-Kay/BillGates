...
/**
 * REST controller for managing {@link com.myapp.domain.Chambre}.
 */
@RestController
@RequestMapping("/api")
@Transactional
    ...
    public ResponseEntity<Chambre> partialUpdateChambre(
        ...
        Optional<Chambre> result = chambreRepository
            ...
            .map(existingChambre -> {
                ...
                if (chambre.getPrixChambre() != null) {
                    existingChambre.setPrixChambre(chambre.getPrixChambre());
                }
                if (chambre.getDisponibilite() != null) {
                    existingChambre.setDisponibilite(chambre.getDisponibilite());
                }
                if (chambre.getImages() != null) {
                    existingChambre.setImages(chambre.getImages());
                }
