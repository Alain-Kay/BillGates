...
/**
 * REST controller for managing {@link com.myapp.domain.Client}.
 */
@RestController
@RequestMapping("/api")
@Transactional
    ...
    public ResponseEntity<Client> partialUpdateClient(
        ...
        Optional<Client> result = clientRepository
            ...
            .map(existingClient -> {
                ...
                if (client.getPostNom() != null) {
                    existingClient.setPostNom(client.getPostNom());
                }
                if (client.getNumeroClient() != null) {
                    existingClient.setNumeroClient(client.getNumeroClient());
                }
