...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_GESTIONNAIRE_LIST actions', async () => {
    ...
    it('dispatches FETCH_GESTIONNAIRE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_GESTIONNAIRE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_GESTIONNAIRE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_GESTIONNAIRE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_GESTIONNAIRE actions', async () => {
      const expectedActions = [
        {
