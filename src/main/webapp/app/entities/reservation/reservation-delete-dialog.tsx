...
export const ReservationDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="billGatesApp.reservation.delete.question">
        <Translate contentKey="billGatesApp.reservation.delete.question" interpolate={{ id: reservationEntity.id }}>
